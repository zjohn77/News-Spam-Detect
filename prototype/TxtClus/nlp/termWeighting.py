...
def doc_term_matrix(snippets, param_dict, tokenize=__tokenize):
    ...
    samp = choice(snippets, param_dict['samp_size'])  # take sample    
    
    vectorizer = TfidfVectorizer(tokenizer = tokenize,
                                 stop_words = __stopwords, 
                                 strip_accents = 'unicode',
                                 sublinear_tf = param_dict['tf_dampen'])
    docTerm_X = vectorizer.fit_transform(samp)
